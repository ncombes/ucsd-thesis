...
%\usepackage{natbib} % a different style %% If using natbib you may need to change your \cite to \citep or \citet
%\newcommand{\newblock}{} % necessary if using natbib
%% String comparisons
...
%\bibliographystyle{plainnat} %% A style for Natbib citation package
